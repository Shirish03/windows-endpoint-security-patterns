...
- [x] Whitepaper 01 BTG — markdown + HTML (styled CSS + Mermaid.js CDN; print to PDF from browser)
...
Whitepaper 01 BTG HTML complete and pushed — next session: Whitepaper 02 SCEP markdown + HTML
